            ...
            <div className="py-20" id="Approach">
                ...
                <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
                    <Card
                        ...
                        description="We will collaborate to map out your website's goals ,target audience and key functionalities. We'll discuss things like site structure, navigation and content requirement"
                    >
                    ...
                    <Card
                        ...
                        description="Once we agree on the plan, I cue my lofi playlist and dive into coding. From initial sketches to polish code, I keep you updated every step of the way."
                    >
                        <CanvasRevealEffect
                            animationSpeed={3}
